...
docker run -d -it --name testdb -v C:\dev\storage\test:/bitnami/postgresql -p 5432:5432 -e POSTGRESQL_USERNAME=admin -e POSTGRESQL_PASSWORD=1234 -e POSTGRESQL_POSTGRES_PASSWORD=1234 -e POSTGRESQL_DATABASE=testdb bitnami/postgresql
